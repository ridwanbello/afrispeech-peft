"""
Evaluate Whisper-medium DoRA fine-tuned model on AfriSpeech-200.
...
Usage:
    ...
    python evaluate_whisper_dora_local.py
"""
...
PEFT_MODEL    = "robello2/whisper-medium-dora-afrispeech-general"
DATA_PATH     = "./afrispeech_arrow"
OUTPUT_DIR    = "./eval_results/whisper-medium-dora-general"
...
def main():
    ...
    tokenizer         = WhisperTokenizer.from_pretrained(BASE_MODEL, use_fast=False)
    ...
    # Patch generation config on both model and base model
